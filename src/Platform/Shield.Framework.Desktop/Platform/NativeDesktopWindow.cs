...
namespace Shield.Framework.Platform
{
    public abstract class NativeDesktopWindow : NativeWindow, INativeDesktopWindow
    {
        ...
        protected NativeDesktopWindow(NativeDesktopWindowDefinition definition, INativeObject parent)
        {
            ...
            m_parent = parent;
            m_childWindows = new Shin.Framework.Collections.Concurrent.ConcurrentList<INativeDesktopWindow>();
        ...
        protected virtual void OnFocusGained(object sender, EventArgs e) { m_isFocused = true; }

        protected virtual void OnFocusLost(object sender, EventArgs e) { m_isFocused = false; }
