...
namespace Shield.Framework.Extensibility
{
    public sealed class ModuleManager : IModuleManager
    {
        ...
        private readonly IList<IModuleLoader> m_loaders;
        private readonly IPlatformLogProvider m_logger;
        private readonly IModuleInitializer m_moduleInitializer;
        private readonly HashSet<IModuleLoader> m_subscribedLoaders;
        ...
        public ModuleManager( /*IModuleLoader[] loaders,*/ IModuleInitializer moduleInitializer,
                                                           IModuleLibrary moduleCatalog,
                                                           IPlatformLogProvider logger)
        {
            ...
            m_loaders = new ConcurrentList<IModuleLoader>( /*loaders*/);
        }
        ...
        public void LoadModule(string moduleName)
        {
            ...
            if (modules == null || moduleInfos.Length == 0)
            ...
            if (moduleInfos.Length != 1)
            {
                throw new DuplicateModuleException(moduleName,
                                                   string.Format("A duplicated module with name {0} has been found in the catalog.", moduleName));
            }
        ...
        public void LoadModule(ModuleInfo module)
        {
            ...
            if (moduleInfos.Count() != 1)
            {
                throw new DuplicateModuleException(module.Name,
                                                   string.Format("A duplicated module with name {0} has been found in the catalog.", module.Name));
            }
        ...
        private IModuleLoader GetLoaderForModule(ModuleInfo moduleInfo)
        {
            ...
            throw new ModuleLoaderNotFoundException(moduleInfo.Name,
                                                    string.Format(CultureInfo.CurrentCulture,
